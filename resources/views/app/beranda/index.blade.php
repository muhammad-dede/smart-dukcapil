        ...
        <div class="page-title d-flex flex-column me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                <li class="breadcrumb-item text-white opacity-75">
                    {{ Request::is('app/beranda') ? 'Beranda' : '' }}
                </li>
            </ul>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div id="kt_user_view_details" class="collapse show">
                            <div class="pb-5 fs-6">
                                ...
                                <div class="text-gray-600">{{ strtolower(auth()->user()->username) }}</div>
                                    ...
                                    <table class="table align-middle table-row-dashed fw-bold text-gray-600 fs-6 gy-5"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>POST /v1/customer/c_61322a2019076/not_found</td>
                                                <td class="pe-0 text-end min-w-200px">10 Nov 2021, 5:20 pm</td>
                                            </tr>
                                            <tr>
                                                <td class="min-w-70px">
                                                    <div class="badge badge-light-warning">404 WRN</div>
                                                </td>
                                                <td>POST /v1/customer/c_61322a2019075/not_found</td>
                                                <td class="pe-0 text-end min-w-200px">25 Jul 2021, 6:05 pm</td>
                                            </tr>
                                            <tr>
                                                <td class="min-w-70px">
                                                    <div class="badge badge-light-warning">404 WRN</div>
                                            ...
                                            <tr>
                                                ...
                                                <td>POST /v1/customer/c_61322a2019073/not_found</td>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-5"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">15 Apr 2021, 10:30 am
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">25 Oct 2021, 5:20 pm
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">
                                            ...
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2021, 8:43 pm
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">
                                            ...
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">25 Jul 2021, 5:20 pm
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">Invoice
                                        ...
                                        <tr>
                                            ...
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2021, 6:43 am
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">
                                            ...
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">24 Jun 2021, 2:40 pm
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">
                                            ...
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">25 Jul 2021, 5:30 pm
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">Invoice
                                            ...
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2021, 2:40 pm
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-400px">
                                            ...
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">10 Nov 2021, 9:23 pm
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                        ...
                                        <div class="mt-1">
                                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                                ...
                                                <div class="image-input-wrapper w-125px h-125px"
                                                    style="background-image: url({{ asset('') }}assets/media/avatars/150-1.jpg">
                                                </div>
                                                <label
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        <div class="fw-bolder d-flex flex-column justify-content-center mb-5">
                            ...
                            <div class="d-flex flex-center" data-kt-add-auth-action="qr-code">
                                <img src="{{ asset('') }}assets/media/misc/qr-code.png" alt="Scan this QR code" />
                            </div>
