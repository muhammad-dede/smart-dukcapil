...
@section('content')
    ...
    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
        <div class="content flex-row-fluid" id="kt_content">
            ...
            @elseif ($layanan->url == 'perubahan-status-keluarga' || $layanan->id == 12)
                @include('app.layanan.form.perubahan-status-keluarga')
            @elseif ($layanan->url == 'perubahan-peristiwa-penting' || $layanan->id == 13)
                @include('app.layanan.form.perubahan-peristiwa-penting')
