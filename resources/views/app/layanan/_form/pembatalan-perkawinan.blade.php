        ...
        <form action="{{ url('app/layanan/store') }}/{{ $layanan->url }}" id="form-pengajuan-layanan"
            ...
            <div class="card-body border-top p-9">
                ...
                <div id="data-pembatalan-perkawinan">
                    <h2 class="mb-5 text-primary">Data Pembatalan Perkawinan</h2>
                    <div class="row mb-5">
                    ...
                    <div class="row mb-5">
                        <label class="col-lg-4 col-form-label required fw-bold fs-6">Tanggal Pelaporan Perkawinan diluar
                            Negeri</label>
                        <div class="col-lg-8 fv-row">
                            <input id="tgl_pelaporan_perkawinan_luar_negeri" type="date"
                                name="tgl_pelaporan_perkawinan_luar_negeri"
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder=""
                                value="{{ old('tgl_pelaporan_perkawinan_luar_negeri') }}" />
                            <small class="tgl_pelaporan_perkawinan_luar_negeri_error text-danger"
                                id="error-text"></small>
