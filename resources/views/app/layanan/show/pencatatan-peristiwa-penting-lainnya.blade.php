    ...
    <div class="card-body p-9">
        ...
        <div id="data-pencatatan-peristiwa-penting-lainnya">
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8">
                    <span
                        class="fw-bolder fs-6 text-gray-800">{{ $pengajuan->data_pengajuan->jenis_kelamin_baru }}</span>
                </div>
            </div>
            <div class="row mb-7">
                ...
                <div class="col-lg-8">
                    <span
                        class="fw-bolder fs-6 text-gray-800">{{ $pengajuan->data_pengajuan->jenis_kelamin_lama }}</span>
                </div>
            </div>
            <div class="row mb-7">
