<div class="card mb-5 mb-xl-10" id="kt_details_view">
    ...
    <div class="card-body p-9">
        <div
            class="notice d-flex bg-light-warning rounded border-{{ $status_pengajuan->color }} border border-dashed p-6 mb-10">
        ...
        <div id="data-saksi">
            ...
            <div class="row mb-7">
                <label class="col-lg-4 fw-bold text-muted">N0 KK Saksi 1</label>
                <div class="col-lg-8">
                    <span
