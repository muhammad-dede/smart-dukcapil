<div class="card mb-5 mb-xl-10" id="kt_details_view">
    ...
    <div class="card-body p-9">
        ...
        <div id="data-pelapor-pencatatan-sipil-dari-luar-wilayah-nkri">
            ...
            <div class="row mb-7">
                <label class="col-lg-4 fw-bold text-muted">Jenis Peristiwa Penting</label>
                <div class="col-lg-8">
                    <span
            ...
            <div class="row mb-7">
                <label class="col-lg-4 fw-bold text-muted">Nomor Surat Keterangan Pelaporan Pencatatan Sipil dari
                    Perwakilan RI</label>
                <div class="col-lg-8">
                    <span
            ...
            <div class="row mb-7">
                <label class="col-lg-4 fw-bold text-muted">Tanggal Surat Keterangan Pelaporan Pencatatan Sipil dari
                    Perwakilan RI</label>
                <div class="col-lg-8">
                    <span
            ...
            <div class="row mb-7">
                <label class="col-lg-4 fw-bold text-muted">Kantor Perwakilan yang Melakukan Pencatatan</label>
                <div class="col-lg-8">
                    <span
            ...
            <div class="row mb-7">
                <label class="col-lg-4 fw-bold text-muted">Nomor Bukti Pencatatan Sipil dari Negara Setempat</label>
                <div class="col-lg-8">
                    <span
            ...
            <div class="row mb-7">
                <label class="col-lg-4 fw-bold text-muted">Tanggal Penerbitan dari Negara Setempat</label>
                <div class="col-lg-8">
                    <span
