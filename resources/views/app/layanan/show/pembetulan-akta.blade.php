    ...
    <div class="card-body p-9">
        ...
        <div id="data-pembetulan-akta">
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8">
                    <span
                        class="fw-bolder fs-6 text-gray-800">{{ $pengajuan->data_pengajuan->nama_ayah_ibu_wali }}</span>
                </div>
            </div>
            <div class="row mb-7">
                ...
                <div class="col-lg-8">
                    <span
                        class="fw-bolder fs-6 text-gray-800">{{ $pengajuan->data_pengajuan->nik_ayah_ibu_wali }}</span>
                </div>
            </div>
