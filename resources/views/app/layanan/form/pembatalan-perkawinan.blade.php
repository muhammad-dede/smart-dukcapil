<div id="data-perkawinan">
    <h2 class="mb-5 text-primary">Data Perkawinan</h2>
    <div class="row mb-5">
        <label class="col-lg-4 col-form-label required fw-bold fs-6">Tanggal Perkawinan</label>
        <div class="col-lg-8 fv-row">
            <input id="tgl_perkawinan" type="date" name="tgl_perkawinan"
                class="form-control form-control-lg form-control-solid" value="{{ old('tgl_perkawinan') }}" />
            <small class="tgl_perkawinan_error text-danger" id="error-text"></small>
    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-8 fv-row">
            <input id="no_akta_perkawinan" type="text" name="no_akta_perkawinan"
                class="form-control form-control-lg form-control-solid" placeholder="Contoh: 3243242****"
    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-8 fv-row">
            <input id="tgl_akta_perkawinan" type="date" name="tgl_akta_perkawinan"
                class="form-control form-control-lg form-control-solid" value="{{ old('tgl_akta_perkawinan') }}" />
    ...
    <div class="row mb-5">
        <label class="col-lg-4 col-form-label required fw-bold fs-6">Nama Pengadilan Pembatalan Perkawinan</label>
        <div class="col-lg-8 fv-row">
            <input id="nama_pengadilan_pembatalan" type="text" name="nama_pengadilan_pembatalan"
                class="form-control form-control-lg form-control-solid" placeholder="Contoh: 3243242****"
                value="{{ old('nama_pengadilan_pembatalan') }}" />
            <small class="nama_pengadilan_pembatalan_error text-danger" id="error-text"></small>
    ...
    <div class="row mb-5">
        <label class="col-lg-4 col-form-label required fw-bold fs-6">Tanggal Pelaporan Perkawinan di Luar Negeri</label>
        <div class="col-lg-8 fv-row">
            <input id="tgl_pelaporan_perkawinan_luar_negeri" type="date" name="tgl_pelaporan_perkawinan_luar_negeri"
                class="form-control form-control-lg form-control-solid"
                value="{{ old('tgl_pelaporan_perkawinan_luar_negeri') }}" />
            <small class="tgl_pelaporan_perkawinan_luar_negeri_error text-danger" id="error-text"></small>
