                ...
                <div id="data-pembatalan-perkawinan">
                    ...
                    <div class="row mb-5">
                        <label class="col-lg-4 col-form-label required fw-bold fs-6">Tanggal Pelaporan Perkawinan diluar
                            Negeri</label>
                        <div class="col-lg-8 fv-row">
                            <input id="tgl_pelaporan_luar_negeri" type="date" name="tgl_pelaporan_luar_negeri"
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder=""
                                value="{{ old('tgl_pelaporan_luar_negeri') }}" />
                            <small class="tgl_pelaporan_luar_negeri_error text-danger" id="error-text"></small>
                            @error('tgl_pelaporan_luar_negeri')
                                <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
