    ...
    <div id="kt_account_profile_details" class="collapse show">
        <form action="{{ url('app/layanan/store') }}/{{ $layanan->url }}" id="form-pengajuan-layanan"
            ...
            <div class="card-body border-top p-9">
                {{-- Data Anak --}}
                <div id="data-pelaporan-luar-nkri">
                    <div class="row mb-5">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input id="nomor_catatan_sipil_perwakilan_ri" type="text"
                                name="nomor_catatan_sipil_perwakilan_ri"
                                class="form-control form-control-lg form-control-solid" placeholder="Contoh: xxx"
                                value="{{ old('nomor_catatan_sipil_perwakilan_ri') }}" />
                            <small class="nomor_catatan_sipil_perwakilan_ri_error text-danger" id="error-text"></small>
                            @error('nomor_catatan_sipil_perwakilan_ri')
                                <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input id="tgl_keterangan_pelaporan_perwakilan_ri" type="date"
                                name="tgl_keterangan_pelaporan_perwakilan_ri"
                                class="form-control form-control-lg form-control-solid" placeholder="Contoh: xxx"
                                value="{{ old('tgl_keterangan_pelaporan_perwakilan_ri') }}" />
                            <small class="tgl_keterangan_pelaporan_perwakilan_ri_error text-danger"
                                id="error-text"></small>
                            @error('tgl_keterangan_pelaporan_perwakilan_ri')
                                <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input id="kantor_perwakilan_pencatatan" type="text" name="kantor_perwakilan_pencatatan"
                                class="form-control form-control-lg form-control-solid"
                                placeholder="Contoh: Imigrasi Kota Cilegon"
                                value="{{ old('kantor_perwakilan_pencatatan') }}" />
                            <small class="kantor_perwakilan_pencatatan_error text-danger" id="error-text"></small>
                            @error('kantor_perwakilan_pencatatan')
                                <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input id="nomor_bukti_catatan_dari_negara_setempat" type="text"
                                name="nomor_bukti_catatan_dari_negara_setempat"
                                class="form-control form-control-lg form-control-solid" placeholder="Contoh: xxx"
                                value="{{ old('nomor_bukti_catatan_dari_negara_setempat') }}" />
                            <small class="nomor_bukti_catatan_dari_negara_setempat_error text-danger"
                                id="error-text"></small>
                            @error('nomor_bukti_catatan_dari_negara_setempat')
                                <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
