                ...
                <div id="data-pembetulan-akta">
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input id="no_akta_yang_dibetulkan" type="text" name="no_akta_yang_dibetulkan"
                                class="form-control form-control-lg form-control-solid" placeholder=""
                                value="{{ old('no_akta_yang_dibetulkan') }}" />
                            <small class="no_akta_yang_dibetulkan_error text-danger" id="error-text"></small>
                            @error('no_akta_yang_dibetulkan')
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input id="nama_wali" type="text" name="no_akta_yang-nama_wali"
                                class="form-control form-control-lg form-control-solid" placeholder=""
                                value="{{ old('nama_wali') }}" />
