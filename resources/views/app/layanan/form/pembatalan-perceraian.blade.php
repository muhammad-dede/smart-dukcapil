                ...
                <div id="data-pembatalan-perceraian">
                    ...
                    <div class="row mb-5">
                        <label class="col-lg-4 col-form-label required fw-bold fs-6">Tanggal Pelaporan Perceraian dari
                            Luar Negeri</label>
                        <div class="col-lg-8 fv-row">
                            <input id="tgl_pelaporan_perceraian_luar" type="date" name="tgl_pelaporan_perceraian_luar"
                                class="form-control form-control-lg form-control-solid" placeholder=""
                                value="{{ old('tgl_pelaporan_perceraian_luar') }}" />
                            <small class="tgl_pelaporan_perceraian_luar_error text-danger" id="error-text"></small>
                            @error('tgl_pelaporan_perceraian_luar')
                                <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
